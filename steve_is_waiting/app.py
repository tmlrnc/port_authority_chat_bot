...
def get_interview_questions(temperature='HIGH'):
    pdf_file_path = "./port_authority_sample_comptecy_questions.pdf"
...
def send_message():
    ...
    elif user_input == "get_competency_question":
        selected_option = data['selectedOption']
        response_text = get_competency_question(selected_option)
    else:
...
def readiness_check():
    # For simplicity, this example always returns a 200 status code
